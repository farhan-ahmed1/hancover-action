...
<coverage version="1.0" line-rate="0.66667" branch-rate="0.5">
    ...
    it('should parse Cobertura from sample fixture', async () => {
        const result = await parseCoberturaFile('test/fixtures/cobertura/cobertura.sample.xml');
    ...
    it('should parse complex Cobertura from fixture', async () => {
        const result = await parseCoberturaFile('test/fixtures/cobertura/cobertura.complex.xml');
